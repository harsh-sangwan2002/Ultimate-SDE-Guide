...
| Concept            | Meaning                                      |
| ------------------ | -------------------------------------------- |
| Lexical Scope      | Access variables based on code location      |
| Scope Chain        | Child searches variables upward              |
| Closure            | Function remembers parent variables          |
...
✅ Closures are widely used in modern JavaScript  
✅ Understanding closures is essential for React & Node.js
