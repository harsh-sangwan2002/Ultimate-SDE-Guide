...
An array arr[i] is interpreted as _(arr+i). Here, arr denotes the address of the first array element or the 0 index element. So _(arr+i) means the element at i distance from the first element of the array.
