...
Now, calculate the floor values of the following logarithms. 5. log<sub>2</sub>(10) = 3 6. log<sub>2</sub>(40) = 5
...
_We use **Asymptotic Analysis** to estimate the performance of an Algorithm when Input is huge._
